...
public class DoorAction implements IActionHandler
{
	...
	public boolean action(Player player, WorldObject target, boolean interact)
	{
		...
		else if (interact)
		{
			...
			else if ((clan != null) && (((Door) target).getFort() != null) && (clan == ((Door) target).getFort().getOwnerClan()) && ((Door) target).isOpenableBySkill() && !((Door) target).getFort().getSiege().isInProgress())
			{
