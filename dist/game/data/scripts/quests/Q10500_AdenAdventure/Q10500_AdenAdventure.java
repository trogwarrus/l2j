...
public class Q10500_AdenAdventure extends Quest
{
	...
	{
		super(QUEST_ID);
		addItemTalkId(82959); // Teleportation Guide - Growth Assistant Tarti
	}
		...
		switch (event)
		{
			case "ACCEPT":
			{
				...
				if (!questState.isStarted() && !questState.isCompleted())
				{
					...
					giveItems(player, 82959, 1); // Teleportation Guide - Growth Assistant Tarti
			...
			case "COMPLETE":
			{
				...
				if (questState.isCond(QuestCondType.DONE) && !questState.isCompleted())
				{
					...
					{
						player.sendPacket(new ExQuestDialog(10501, QuestDialogType.ACCEPT));
					}
				}
				break;
			}
