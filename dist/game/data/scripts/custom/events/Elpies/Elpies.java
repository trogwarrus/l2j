...
public class Elpies extends Event
{
  ...
  public boolean eventStart(Player eventMaker)
  {
    ...
    Broadcast.toAllOnlinePlayers("Нашестиве элпи на " + randomLoc.getName());
    Broadcast.toAllOnlinePlayers("Помогите уничтожить их!");
  ...
  public boolean eventStop()
  {
    ...
    Broadcast.toAllOnlinePlayers("*Squeak Squeak*");
    Broadcast.toAllOnlinePlayers("Нашествие закончилось!");
    return true;
  }
  ...
  public String onKill(Npc npc, Player killer, boolean isSummon)
  {
    if (EVENT_ACTIVE)
    {
      ...
      {
        Broadcast.toAllOnlinePlayers("Все элпи были убиты!");
        eventStop();
      }
    }
